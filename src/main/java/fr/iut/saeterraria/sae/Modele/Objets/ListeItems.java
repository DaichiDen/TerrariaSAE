...
public enum ListeItems {
    Ciel(0,new Bloc("Ciel", 10,0)),
    Terre_Haute(1, new Bloc("Terre Haute", 1,1)),
    Terre_Basse(2, new Bloc("Terre Basse", 1,2)),
    Bois(3, new Bloc("Bois", 1,3)),
    Minerai_Charbon(4, new Bloc("Minerai Charbon", 2,4)),
    Pierre(5, new Bloc("Pierre", 2,5)),
    Minerai_Fer(6, new Bloc("Minerai Fer", 3,6)),
    Minerai_DELJCCium(7, new Bloc("Minerai DELJCCium", 4,7)),
    Pique(8, new Bloc("Pique", 10,8)),
    BedRock(9, new Bloc("BedRock", 10,9)),
    Noir(10, new Bloc("Noir", 10,10)),
    ...
    Coffre(20, new Coffre("Coffre", 3,20)),
    Charbon(21, new Item("Charbon",1,21)),
    Fer(22, new Item("Fer",1,22)),
    ...
    Fleche(77, new Item("Flèche",1,77)),
    Arc_Bois(78, new Distance("Arc en bois",10,78)),

    Arquebuse(79, new Distance("Arquebuse", 5,79)),

    Balle_Plonb(80, new Item("Balle en plomb",1,80)),
    Grappin(81, new Grappin("Grappin","Permet de s'accrocher aux surfaces",0,81)),


    Boule_De_Feu(82, new Item("Boule de feu",1,82));
