...
public enum ListeItems {
    ...
    Terre_Haute(1, new Bloc("Terre Haute","Bloc commun qui recouvre le monde", 1)),
    Terre_Basse(2, new Bloc("Terre Basse","Bloc commun qui recouvre le sol du monde", 1)),
    Bois(3, new Bloc("Bois","Element indispensable, base de créativité", 1)),
    Minerai_Charbon(4, new Bloc("Minerai Charbon","Bloc contenant plusieurs charbons", 2)),
    Pierre(5, new Bloc("Pierre","Bloc basique de pierre commun dans les sous-sol", 2)),
    Minerai_Fer(6, new Bloc("Minerai Fer","Métal commun de Fer", 3)),
    Minerai_DELJCCium(7, new Bloc("Minerai DELJCCium","", 4)),
    Pique(8, new Bloc("Pique","", 10)),
    BedRock(9, new Bloc("BedRock","Incassable", 10)),
    Noir(10, new Bloc("Noir","Incassable+traversable fond", 10)),

    ConstructionSansBloc(11, new BlocConstruction("ConstructionSansBloc","",0,0)),
    Etabli(12, new BlocConstruction("Etabli","Un établi qui permet la fabrication d'objets",1,1,null)),
    Forge(13, new BlocConstruction("Forge","Un établi qui permet la fabrication d'objets",1,3,null)),
    Four(14, new BlocConstruction("Four","Permet de fondre et cuire ses objets",1,2,null)),

    Planche_Bois(15, new Bloc("Planche de bois","", 1)),
    Toit_Bois_Gauche(16, new Bloc("Toit_bois_gauche","", 1)),
    Toit_Bois_Droite(17, new Bloc("Toit bois droite", "", 1)),
    Mur_Bois_Fonce(18, new Bloc("Fonce bois mur", "", 0)),
    Feuilles(19, new Bloc("Feuilles", "", 1)),

    Coffre(20, new Coffre("Coffre", "", 3, 3)),
    Charbon(21, new Item("Charbon","Permet d'alimenter le four et la forge en chaleur",1)),
    Fer(22, new Item("Fer","Métal obtenu en fondant des Minerai de Fer",1,null)),
    DELJCCium(23, new Item("DELJCCium", "", 1,null)),

    Pierre_TP(49, new Pierre_TP()),
    Pioche_Bois(51, new Pioche("Pioche de bois","",2,null)),
    Pioche_Pierre(52, new Pioche("Pioche de pierre","",3,null)),
    Pioche_Fer(53, new Pioche("Pioche de fer","",4,null)),
    Pioche_DELJCCium(54 ,new Pioche("Pioche DELJCCium","",5,null)),

    Seau_Vide(62, new Item("Seau vide", "", 1,null)),
    Seau_Eau(63, new Item("Seau eau", "", 1,null)),

    Casque_Fer(64, new Armure("Casque en fer","",2,null,1)),
    Casque_DELJCCium(65, new Armure("Casque en DELJCCium","",3,null,1)),
    Plastron_Fer(66, new Armure("Plastron en fer","",6,null,2)),
    Plastron_DELJCCium(67, new Armure("Plastron en DELJCCium","",9,null,2)),
    Jambiere_Fer(68, new Armure("Jambière en fer","",4,null,3)),
    Jambiere_DELJCCium(69, new Armure("Jambière en DELJCCium","",6,null,3)),
    Botte_Fer(70, new Armure("Botte en fer","",3,null,4)),
    Botte_DELJCCium(71, new Armure("Botte en DELJCCium","",5,null,4)),

    Katana_Etrange(72, new DashingKatana("Katana étrange","Ce Katana semble pouvoir octroyer la capacité à son détenteur de se déplacer à la vitesse du son",10)),
    Epee_Bois(73, new Epee("Epée en Bois","",1,null)),
    Epee_Pierre(74, new Epee("Epée en Pierre","",3,null)),
    Epee_Fer(75, new Epee("Epée en Fer","",4,null)),
    Epee_DELJCCium(76, new Epee("Epée en DELJCCium","",5,null)),

    Fleche(77, new Item("Flèche","Flèche",1,null)),
    Arc_Bois(78, new Distance("Arc en bois","Un vieil arc usé",10,null)),
    Arquebuse(79, new Distance("Arquebuse","Etrange objet qui semble ralentir le temps",5)),
    Balle_Plonb(80, new Item("Balle en plomb","Un projectile qui peut être utlisé",1)),
    Grappin(81, new Distance("Grappin","Permet de s'accrocher aux surfaces",0,null)),
    Boule_De_Feu(82, new Item("Boule de feu","Une boule de feu qui explose à l'impact",1));
